...
$(function () {
    ...
    let table=$('#suppliersTable').DataTable({
        ...
        columns: [
            ...
            { data: 'opening_balance', name: 'opening_balance',searchable: true },
    ...
    $(document).on('change', '.supplierStatusToggler', function () {
        let id = $(this).data('id');
        let status = $(this).is(':checked') ? 1 : 0;
        Swal.fire({
            title: 'Updating Supplier...',
            text: 'Please wait while the supplier is being updated.',
            allowOutsideClick: false,
