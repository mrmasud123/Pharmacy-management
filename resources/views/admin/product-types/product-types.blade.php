...
@section('content')
    ...
    <x-common.page-breadcrumb :pageTitle="[['name' => 'Product Types', 'link' => '#']]" />
    ...
    <div class="bg-white dark:bg-white/5 rounded-2xl shadow-lg p-6">
        ...
        <div class="flex items-center justify-between mb-5">
            ...
            <a href="{{ route('admin.product.type.create') }}"
        ...
        <div class="overflow-x-auto">
            <table id="productTypesTable" class="datatable w-full text-sm text-left border-separate border-spacing-y-2">
